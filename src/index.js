...
data.map((prof, index) => {
    ...
    // icon.innerHTML="<i class=fas fa-hand-holding-usd'></i>"
    ...
    const p_case_personal_info = document.createElement("p")
    ...
    p_case_personal_info.textContent = prof.personalFile.info
    p_Case.textContent = "Cases :"
    ...
    profile_case.appendChild(p_case_personal_info)
    ...
    folder.appendChild(profile_section)
    folder.appendChild(profile_case)
